...
const Bid: React.FC<{
  ...
  const nounsAuctionHouseContract: any = new BlocksAuctionHouseFactory().attach(
  ...
  const placeBidHandler = async () => {
    ...
    const gasLimit = await contract.estimateGas.createBid(auction.blockId, {
      value,
    });
    placeBid(auction.blockId, {
      value,
