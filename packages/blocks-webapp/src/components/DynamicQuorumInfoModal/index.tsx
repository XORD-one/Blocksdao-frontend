        ...
        <div className={classes.content}>
          ...
          <p className={classes.mainCopy}>
            {window.innerWidth < 1200 ? (
              <Trans>
                The Quorum (minimum number of For votes required to pass a
                proposal) is set as a function of the number of Against votes a
                proposal has recieved. It increases quadratically as a function
                of the % of Nouns voting against a prop, varying between Min
                Quorum and Max Quorum.
              </Trans>
            ) : (
              <Trans>
                The Quorum (minimum number of For votes required to pass a
                proposal) is set as a function of the number of Against votes a
                proposal has recieved. The number of For votes required to pass
...
const DynamicQuorumInfoModal: React.FC<{
  ...
  // pass dao contract address here
  const dynamicQuorumProps = useDynamicQuorumProps("", proposal.startBlock);
