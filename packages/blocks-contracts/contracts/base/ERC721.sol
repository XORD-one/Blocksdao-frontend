...
// https://github.com/OpenZeppelin/openzeppelin-contracts/blob/6618f9f18424ade44116d0221719f4c93be6a078/
// contracts/token/ERC721/ERC721.sol
//
// ERC721.sol source code copyright OpenZeppelin licensed under the MIT License.
// With modifications by Nounders DAO and is being used by Block DAO.
//
//
// MODIFICATIONS:
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint256 => address) private _owners; // _owners[tokenId] = owner
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        _balances[owner] -= 1;
        delete _owners[tokenId]; // make the tokenId zero which is default value
        // It is important to clear the owner after the balance is
        // decremented to prevent reentrancy attacks
