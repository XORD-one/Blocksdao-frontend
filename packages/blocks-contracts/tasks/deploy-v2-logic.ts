...
task('deploy-v2-logic', 'Deploys BlocksDAOLogicV2').setAction(async (_args, { ethers, run }) => {
  const factory = await ethers.getContractFactory('BlocksDAOLogicV2');
  ...
  console.log(`BlocksDAOLogicV2 deployed to ${contract.address}`);
