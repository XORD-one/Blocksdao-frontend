...
task('deploy-short-times', 'Deploy all Blocks contracts with short gov times for testing')
    ...
    const contracts: Record<ContractNamesDAOV2, ContractDeployment> = {
      ...
      BlocksDAOProxyV2: {
        args: [
          ...
          args.noundersdao,
          () => deployment.BlocksDAOExecutor.address,
          () => deployment.BlocksDAOLogicV2.address,
          args.votingPeriod,
          args.votingDelay,
        ...
        validateDeployment: () => {
          ...
          const actual = deployment.BlocksDAOProxyV2.address.toLowerCase();
          if (expected !== actual) {
            throw new Error(
    ...
    for (const [name, contract] of Object.entries(contracts)) {
      ...
      switch (name) {
        case 'BlocksDAOExecutor':
          ...
          break;
        case 'BlocksDAOLogicV2':
          nameForFactory = 'BlocksDAOLogicV2Harness';
          break;
        default:
          nameForFactory = name;
          break;
