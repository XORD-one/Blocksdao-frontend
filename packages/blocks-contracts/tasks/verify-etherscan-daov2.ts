...
const nameToFullyQualifiedName: Record<string, string> = {
  BlocksAuctionHouseProxy: 'contracts/proxies/BlocksAuctionHouseProxy.sol:BlocksAuctionHouseProxy',
  BlocksAuctionHouseProxyAdmin: 'contracts/proxies/BlocksAuctionHouseProxyAdmin.sol:BlocksAuctionHouseProxyAdmin',
  BlocksDAOLogicV2Harness: 'contracts/test/BlocksDAOLogicV2Harness.sol:BlocksDAOLogicV2Harness'
};
